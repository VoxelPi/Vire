...
internal interface PartialInputStateProviderWrapper : PartialInputStateProvider {

    val inputStateProvider: PartialInputStateProvider
    ...
    override fun hasValue(input: Input): Boolean {
        return inputStateProvider.hasValue(input)
    }

    override fun allInputsSet(): Boolean {
        return inputStateProvider.allInputsSet()
    }
}

internal interface MutablePartialInputStateProviderWrapper : PartialInputStateProviderWrapper, MutablePartialInputStateProvider {
